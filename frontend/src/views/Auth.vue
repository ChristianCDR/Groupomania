...
<template>
  <body>
    ...
    <form class="form-2" v-if="mode=='signup'">
      <h1>Inscrivez-vous</h1>
      <label for="nom"></label>
      <input v-model="nom" placeholder="Nom" id="nom"/>
      <label for=""></label>
      <input v-model="prenom" placeholder="Prenom" id="prenom"/>
      <label for="email"></label>
      <input @change="setAdmin" v-model="email" placeholder="Email: example@groupomania.fr" id="email"/>
      <label for="motDePasse"></label>
      <input @change="validPassword" v-model="motDePasse" placeholder="Mot de passe" id="motDePasse"/>
...
<script>
  ...
  export default { 
    ...
    computed:{
      //On s'assure que chaque input a une valeur
    ...
    methods:{
      //Deux modes pour afficher le bon formulaire au user
      loginMode: function(){
        this.mode="login"
      },
      signUpMode: function(){
      ...
      //Permet de savoir si c'est l'admin qui se connecte
      ...
      //On appelle l'action qui va faire l'appel Backend pour LogIn
      ...
      //On appelle l'action qui va faire l'appel Backend pour Sign up
      signUserUp: function(){
